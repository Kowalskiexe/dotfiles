...
local function my_hover()
    vim.notify("my hover")
end
--vim.keymap.set("n", "K", function() vim.lsp.buf.hover({ on_list = my_hover }) end, { noremap = true, silent = true })
-- vim.keymap.set("n", "K", my_hover, opts)
-- vim.lps.handlers["textDocument/hover"] = my_hover
