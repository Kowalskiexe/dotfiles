...
test -e ~/.config/.anthropic_api_key && set -x ANTHROPIC_API_KEY (cat ~/.config/.anthropic_api_key)
test -e ~/.config/.gemini_api_key && set -x GEMINI_API_KEY (cat ~/.config/.gemini_api_key)
